...
from models.common import PointNetSetAbstraction, FlowEmbedding, PointNetFeaturePropogation
...
class FlowStep3D(nn.Module):
    ...
    def forward(self, batch_data, configs):
        pc1, feature1 = batch_data['pc1_transformed'], batch_data['pc1_transformed']
        pc2, feature2 = batch_data['pc2_transformed'], batch_data['pc2_transformed']
        iters = configs['model_params']['train_iters']
        # ---------------------- init ----------------------------
        flow_predictions = []
        ...
        # print('flowstep3d', flow_predictions[0].shape)
        output = {
            'flows': flow_predictions,
            'pred_flow': flow_predictions[-1]
        }
